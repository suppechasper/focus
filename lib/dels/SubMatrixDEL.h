#ifndef SUBMATRIXDEL_H
#define SUBMATRIXDEL_H
...
class SubMatrixDEL : public AdjustableDisplayElement{
...
#define BUFSIZE 512
  ...
  public:
    ...
    SubMatrixDEL( Data<TPrecision> &d, int nRows, int nCols, std::vector<int> ind, bool columnMajor=true,
              bool tpose=false, bool aspect=true ) : data(d), m(nRows),
              n(nCols), indices(ind), keepAspect(aspect), transpose(tpose),
              cMajor(columnMajor){ 
